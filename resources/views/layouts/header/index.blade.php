    ...
    <div class="page-topbar-bottom">
      <div class="container">
         <div class="d-flex align-items-center justify-content-between flex-column flex-md-row">
             ...
             <div class="page-topbar-social d-none d-md-block"> @if ($setting->facebook !==null)
               <ul class="list-inline mb-0">
                   <li class="list-inline-item"> <a class="fa fa-facebook-f" href="{{$setting->facebook}}" title="Facebook" rel="nofollow noopener external noreferrer" target="_blank" data-wpel-link="external"></a>
                   </li>
               </ul>
               @endif
           </div>
